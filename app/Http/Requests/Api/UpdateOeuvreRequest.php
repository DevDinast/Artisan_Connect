...
class UpdateOeuvreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prix' => 'sometimes|required|numeric|min:1000|max:999999.99',
            'quantite_disponible' => 'sometimes|required|integer|min:0|max:999',
    ...
    public function messages(): array
    {
        return [
            ...
            'quantite_disponible.min' => 'La quantité doit être supérieure ou égale à 0',
